...
set_input_delay -clock clk -max 10 [get_ports {data_in_b}]
set_input_delay -clock clk -max 0.4 [get_ports {data_in_a}]
set_input_delay -clock clk -max 0.2 [get_ports {op* reg_b}]

# ------------------------- Output constraints ---------------------------------

set_output_delay -clock clk -max 15 [get_ports {bulk_data_reg}]
